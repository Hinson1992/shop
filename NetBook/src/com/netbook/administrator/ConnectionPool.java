...
public class ConnectionPool {
	...
	public static void main(String[] args) {
		...
		// List<Book> list=null;
		// ResultSetHandler<List<Book>> bl=new
		// BeanListHandler<Book>(Book.class);
		// String sql
		// ="select * from t_book t,( select bid from t_cartitem where uid='123' and cartStatus=0) c where  t.bid=c.bid";
		System.out.println(qr);
	     /*	
		 * try { list=qr.query(sql, bl); System.out.println(list.size()); }
