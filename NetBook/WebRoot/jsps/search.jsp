...
<style type="text/css">
  ...
  <body>
    <form action="book.do?n=search" method="post" target="body" id="form1">
    	<input type="hidden" name="method" value=""/>
    	<input type="text" name="bname" placeholder="请输入图书名..."/>
    	<span>
    	...
    	<input type="button" value="返回" style="width: 50px; " onclick="javascript:history.go(-1);">
    </form>
  </body>
</html>
