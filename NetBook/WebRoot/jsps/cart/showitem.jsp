...
<script type="text/javascript">
	...
	function getorder(){
	   var adderss =$("#addr").val();
	   alert(adderss);
	   location.href="../../order/OrderServlet?method=addOrder&address="+adderss;
	}
</script>
  </head>
...
<table width="95%" align="center" cellpadding="0" cellspacing="0">
  ...
  <c:forEach  items="${sessionScope.cartList.getCartItems() }" var="list" >
	<tr align="center">
		<td align="right">
		...
		<td align="left">
			<a href="<c:url value='/jsps/book/desc.jsp'/>"><span>${list.book.bname}--${list.cartItemId}</span></a>
		</td>
		<td>&yen;${list.book.currPrice}</td>
		<td>${list.quantity}</td>
		<td>
			<span class="price_n">&yen;<span class="subtotal">${list.getSubtotal()}</span></span>
		</td>
	</tr>
	</c:forEach>
	...
	<tr>
		<td style="border-top-width: 4px;" colspan="5" align="right">
			<a id="linkSubmit" href="javascript:void(0);"  onclick="getorder()">提交订单</a>
		</td>
	</tr>
</table>
</form>
